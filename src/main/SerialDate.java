...
public abstract class SerialDate implements Comparable,
    ...
    /**
     * Returns true if this Serial represents the same date as the specified SerialDate
     * @param other the date being compared to
     ...
     * @return <code>true</code> if this SerialDate represents an earlier adate
    ...
    /**
     * Returns <code>true</code> if this {@link SerialDate} represents the same date as the
